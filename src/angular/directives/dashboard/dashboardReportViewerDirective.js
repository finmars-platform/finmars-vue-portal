		...
		link: function (scope, elem, attr) {
			...
			scope.openComponentSettingsEditorDialog = function ($event) {
				...
				$mdDialog
					.show({
						controller:
							'DashboardReportViewerComponentSettingsDialogController as vm',
						templateUrl:
							'views/dialogs/dashboard/component-settings/dashboard-report-viewer-component-settings-dialog-view.html',
			...
			scope.disableFillInMode = function () {
				var tableComponents =
					scope.fillInModeData.entityViewerDataService.getComponents()

				tableComponents.topPart = false
				tableComponents.sidebar = false

				scope.fillInModeData.entityViewerDataService.setComponents(
					tableComponents
				)
			...
			scope.initEventListeners = function () {
				...
				if (scope.fillInModeData) {
					// if dashboard is in fillIn mode
