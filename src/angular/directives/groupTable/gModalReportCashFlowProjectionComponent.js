 ...
 */
	...
	export default function (
				...
				;(function (index) {
					...
					setTimeout(function () {
						...
						if (
							...
							!$(checkboxes[index]).hasClass('md-g-green') &&
							!$(checkboxes[index]).hasClass('md-primary')
						) {
		...
		vm.getAttributes = function () {
			...
			vm.transactionAttrs = metaService
				.getEntityAttrs('transaction-report')
				.map(function (item) {
					item.name = 'Transaction.' + item.name
					return item
				})

			vm.cashFlowProjectionAttrs = metaService
				.getEntityAttrs('cash-flow-projection-report')
				.map(function (item) {
