...
var formatPercentage = function (value, column, applySuffix) {
	...
	if (numberFormat) {
		if (
			numberFormat.number_multiplier ||
			numberFormat.number_multiplier === 0
		) {
...
var isFirstInWholeChain = function (evDataService, obj, levelFrom) {
	...
	result = _checkChildInWholeChain(
		evDataService,
		obj,
		relativeRootParent,
		result
...
var _checkChildInWholeChain = function (
	evDataService,
	obj,
	relativeRootParent,
	result
...
var isCellWithProxylineFoldButton = function (
	evDataService,
	obj,
	columnNumber
) {
