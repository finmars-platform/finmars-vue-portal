...
var calculateRecords = function (data) {
	...
	return xhrService.fetch(
		baseUrl +
			...
			apiVersion +
			'/' +
			'portfolios/portfolio-register/calculate-records/',
		{
			method: 'POST',
			credentials: 'include',
			headers: {
...
var updateBulk = function (portfolios) {
	...
	return xhrService.fetch(
		baseUrl +
			...
			apiVersion +
			'/' +
			'portfolios/portfolio-register/bulk-update/',
		{
			method: 'PATCH',
			credentials: 'include',
			headers: {
	...
	return xhrService
		.fetch(
			baseUrl +
				...
				apiVersion +
				'/' +
				'portfolios/portfolio-register/bulk-delete/',
			{
				method: 'POST',
				credentials: 'include',
				headers: {
