		...
		switch (entityType) {
			...
			case 'complex-transaction':
				return new Promise(function (resolve, reject) {
					transactionTypeService
						.initBookComplexTransaction(entity.transaction_type)
						.then(function (data) {
							var res = Object.assign(data, entity)

							transactionTypeService
								.bookComplexTransaction(entity.transaction_type, res)
								.then(function (data) {
									resolve(data)
								})
						})
			...
			case 'complex-transaction':
				...
				return new Promise(function (resolve, reject) {
					return complexTransactionService
						.initRebookComplexTransaction(id)
						.then(function (data) {
							...
							complexTransactionService
								.rebookComplexTransaction(id, entity)
								.then(function (data) {
									resolve(data)
								})
						})
