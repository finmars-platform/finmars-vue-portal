export default [
	...
	},
	{
		...
		value_type: 10,
		notes:
			"iff( str(item_type_name) == 'Instrument' , 'Inst: ' , 'Cash: ' ) + str(user_code)",
		custom_field: {
			id: 24,
			name: 'Linked: Account',
			user_code: 'linked_account',
	...
	},
	{
		attribute_type: {
			...
			prefix: null,
			favorites:
				'RUB(Russian Ruble - RUSSIAN FEDERATION (THE) - 643),USD(US Dollar - UNITED STATES OF AMERICA (THE) - 840),CHF(Swiss Franc - SWITZERLAND - 756)',
			expr: '""',
			can_recalculate: false,
			tooltip: null,
			kind: 1,
