<template>
	<BaseModal
		class="classifier-select-dialog-view dialog-actions-bottom classifierSelectorElemToDrag"
		:title="vm.label"
	>
		<div class="classifier-sel-content">
			<div ng-hide="vm.showFavorites" class="classifier-sel-tree-wrapper">
				<div ng-if="vm.tree" class="height-100">
					<classifier-tree
						...
						on-active-nodes-change-callback="vm.onActiveNodesChange(activeNodesList)"
					></classifier-tree>
				</div>
			</div>
			...
			<div
				...
				class="classifier-sel-favorites-container flex-column"
			>
				...
				<div class="classifier-sel-favorites-holder">
					<div
						ng-repeat="favNode in vm.favoritesList | filter: {'name': vm.favoritesFilterTerms}"
					>
						<div
							class="fav-node-row"
						...
						>
							...
							<div ng-show="!favNode.editOn" class="fav-node-btns-holder">
								<button
									ng-click="vm.removeNodeFromFavorites($event, favNode.pathToNode)"
									class="fav-node-btn"
								>
							...
							<div
								ng-show="favNode.editOn"
								class="flex-row flex-0-1-100 fi-center"
							>
								<input
								...
								/>
								<button
									data-ng-click="vm.saveNode($event, favNode)"
								...
								<button
									data-ng-click="vm.cancelEdit($event, favNode)"
									class="classifier-node-btn flex-row"
								>
			...
			<div class="classifier-sel-tabs-holder flex-row">
				<div
					ng-click="vm.showFavorites = true;"
				...
				<div
					ng-click="vm.showFavorites = false;"
					class="classifier-sel-tab"
					ng-class="{'active': !vm.showFavorites}"
					ng-bind="vm.sellAllTabName"
				>
					ALL
				</div>
			</div>
		...
		<template #controls>
			<div>
				<button data-ng-if="vm.isLock" data-ng-click="vm.isLock = false">
					<span class="material-icons">lock</span>
				</button>
				<button
					data-ng-if="!vm.isLock"
					ng-hide="vm.showFavorites"
				...
				<button
					...
					data-ng-disabled="!vm.activeNodesExist() || vm.isEdit || !vm.readyStatus"
				>
				...
				>
					...
					<md-tooltip class="tooltip_1" md-direction="top"
						>Sort tree alphabetically</md-tooltip
					>
				</button>
			</div>
			...
			<div>
				...
				<md-button
					ng-click="vm.agree()"
					ng-disabled="!vm.readyStatus || vm.isEdit"
					class="link-button"
				>
					<span>OK</span>
				</md-button>
...
<script setup>
	...
	import classifierEvents from '@/angular/services/events/classifierEvents'
