<template>
	<div :class="{'disabled-field': !isEditableField()}">
		...
		<div :class="{'display-none': !vm.readyStatus.content}">
			...
			<div v-if="vm.fieldType['display_name'] === 'Number'"
			...
			<div v-if="vm.fieldType['display_name'] === 'Field' || vm.fieldType['display_name'] === 'Multiple choice field'">
			...
			<div v-if="vm.fieldType['display_name'] === 'Date'" class="field-date-pick">
				<date-input
					label="{{getName()}}"
					model="vm.model"
					custom-buttons="item.buttons"
			...
			<div v-if="vm.fieldType['display_name'] === 'Datetime'" class="field-date-pick">
				<datetime-input
					label="{{getName()}}"
					model="vm.model"
					custom-buttons="item.buttons"
			...
			<div v-if="vm.fieldType['display_name'] === 'Boolean' && hideIscanceledCheckbox(getName())">
				<md-checkbox
			...
			<div v-if="vm.fieldType['display_name'] === 'Decoration' && item.key === 'layoutLine'"
					 class="ec-decoration-container">
				<span class="ec-decoration line" style="{{vm.inputBackgroundColor()}}"></span>
			</div>

			<div v-if="vm.fieldType['display_name'] === 'Decoration' && item.key === 'layoutLineWithLabel'"
					 class="ec-decoration-container">
			...
			<div v-if="vm.fieldType['display_name'] === 'Decoration' && item.key === 'layoutPlainText'"
					 class="ec-decoration-container">
				<span class="ec-decoration plain-text" v-bind="item.options.plainText"></span>
			</div>

			<div v-if="vm.fieldType['display_name'] === 'Decoration' && item.key === 'layoutCalculatedText'"
					 class="ec-decoration-container">
				<span class="ec-decoration plain-text" v-bind="item.options.result"></span>
			</div>
			...
			<div v-if="vm.fieldType['display_name'] === 'Table'" style="padding: 0 10px;">
				<bind-field-table item="item" entity="entity"></bind-field-table>
			</div>

		</div>

		<div v-if="!vm.readyStatus.content" class="bind-field-loader" style="height: 42px; margin-bottom: 13px;">
