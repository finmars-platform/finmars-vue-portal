<template>
	<div class="popup-menu">
		...
		<div
			v-if="
				layout.sourced_from_global_layout && !layout.origin_for_global_layout
			"
			class="layout-menu-item"
...
<script>
	...
	scope.createNewLayout = function () {
		...
		if (activeLayoutConfig && activeLayoutConfig.data) {
			layoutCurrentConfig = scope.evDataService.getLayoutCurrentConfiguration(
				scope.isReport
			)
	...
	const getLayouts = async () => {
		...
		const autosaveLayoutUserCode =
			autosaveLayoutService.getAutosaveLayoutUserCode(scope.targetContentType)
