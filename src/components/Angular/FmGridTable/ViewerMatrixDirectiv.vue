<template>
	<div class="report-viewer-matrix rvMatrix" :class="{'matrix-with-fixed-totals': matrixView === 'fixed-totals'}">
		<div v-if="!processing"
			...
			<div class="report-viewer-matrix-holder rvMatrixHolder"
				...
				<div v-if="viewContext === 'dashboard'"
					...
					<button v-if="canChangeAbscissaAttr"
									custom-popup
					...
					<button v-if="canChangeOrdinateAttr"
									custom-popup
									popup-template-url="'views/popups/selector-popup-view.html'"
				...
				<div class="report-viewer-matrix-row rv-matrix-header" flex="noshrink">
					...
					<div class="report-viewer-matrix-column-header-cell report-viewer-empty-header-cell text-{{styles.cell.text_align}} firstColumnCell rvMatrixCell">
						...
						<div v-if="canChangeValueAttr"
							...
							<button custom-popup
								...
								<div class="selected-option-name" v-bind="matrixValueAttrName"></div>
					...
					<div class="rvm-header-row-holder">
						<div class="rv-matrix-part-to-scroll rvmHeaderScrollableRow">
							...
							<div v-if="matrixView !== 'fixed-totals'"
