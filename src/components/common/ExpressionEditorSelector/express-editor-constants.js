export const FUNCTIONS_ITEMS = [
	...
	},
	{
		name: 'Short name',
		description:
			'[portfolio].short_name: Text - system short name for portfolio<br/><br/>[portfolio]: Portfolio - variable contains portfolio (portfolio unique user code) defined by user in scheme, transaction type - user can address to the attributes of this object/entity (portfolio) via these functions<br/><br/>Examples: <br/>portfolio.short_name - if name of variable is [portfolio]<br/>prtf.short_name - if name of variable is [prtf]',
		groups: 'portfolio',
		func: '.short_name',
		validation: {
	...
	},
	{
		name: 'Short name',
		description:
			'[responsible].short_name: Text - system short name for responsible<br/><br/>[responsible]: Responsible - variable contains responsible (responsible unique user code) defined by user in scheme, transaction type - user can address to the attributes of this object/entity (responsible) via these functions<br/><br/>Examples: <br/>responsible.short_name - if name of variable is [responsible]<br/>resp.short_name - if name of variable is [resp]',
		groups: 'responsible',
		func: '.short_name',
		validation: {
	...
	},
	{
		name: 'Short name',
		description:
			'[counterparty].short_name: Text - system short name for counterparty<br/><br/>[counterparty]: Counterparty - variable contains counterparty (counterparty unique user code) defined by user in scheme, transaction type - user can address to the attributes of this object/entity (counterparty) via these functions<br/><br/>Examples: <br/>counterparty.short_name - if name of variable is [counterparty]<br/>ctpy.short_name - if name of variable is [ctpy]',
		groups: 'counterparty',
		func: '.short_name',
		validation: {
	...
	},
	{
		name: 'Instrument',
		description:
			'System entity Instrument include these attributes-parameters:<br/>- user_code<br/>- name<br/>- short_name<br/>- pricing_currency.name<br/>- pricing_currency.user_code<br/>- reference_for_pricing<br/>- price_multiplier<br/>- accrued_currency.user_code<br/>- accrued_currency.name<br/>- accrued_multiplier<br/>- default_price<br/>- default_accrued<br/>- maturity_date<br/>- maturity_price<br/><br/>The user can get these parameters for each instrument by using expression [instrument].name_of_parameter where [instrument] is a variable contains instrument (see examples for Instrument)',
		groups: 'data_types',
		func: 'System Entities',
		validation: {
			func: 'System Entities'
	...
	},
	{
		name: 'Portfolio',
		description:
			'System entity Portfolio include these attributes-parameters:<br/>- user_code<br/>- name<br/>- short_name<br/><br/>The user can get these parameters for each instrument by using expression [portfolio].name_of_parameter where [portfolio] is a variable contains portfolio (see examples for portfolio)',
		groups: 'data_types',
		func: 'System Entities',
		validation: {
			func: 'System Entities'
	...
	},
	{
		name: 'Account',
		description:
			'System entity Account include these attributes-parameters:<br/>- user_code<br/>- name<br/>- short_name<br/>- public_name<br/><br/>The user can get these parameters for each account by using expression [account].name_of_parameter where [account] is a variable contains account (see examples for account)',
		groups: 'data_types',
		func: 'System Entities',
		validation: {
			func: 'System Entities'
	...
	},
	{
		name: 'Responsible',
		description:
			'System entity Responsible include these attributes-parameters:<br/>- user_code<br/>- name<br/>- short_name<br/><br/>The user can get these parameters for each responsible by using expression [responsible].name_of_parameter where [responsible] is a variable contains responsible (see examples for responsible)',
		groups: 'data_types',
		func: 'System Entities',
		validation: {
			func: 'System Entities'
	...
	},
	{
		name: 'Counterparty',
		description:
			'System entity Counterparty include these attributes-parameters:<br/>- user_code<br/>- name<br/>- short_name<br/><br/>The user can get these parameters for each counterparty by using expression [counterparty].name_of_parameter where [counterparty] is a variable contains counterparty (see examples for counterparty)',
		groups: 'data_types',
		func: 'System Entities',
		validation: {
			func: 'System Entities'
	...
	},
	{
		name: 'Currency',
		description:
			'System entity Currency include these attributes-parameters:<br/>- user_code<br/>- name<br/>- reference_for_pricing<br/><br/>The user can get these parameters for each currency by using expression [currency].name_of_parameter where [currency] is a variable contains currency (see examples for currency)',
		groups: 'data_types',
		func: 'System Entities',
		validation: {
			func: 'System Entities'
	...
	},
	{
		name: 'Strategy 1',
		description:
			'[strategy1] :: [Result: Strategy]<br/><br/>[Result: Strategy]:  Strategy - variable autofilled from the Context (see Context Variables / Context).  The variable stores the Strategy 1 of the selected Context.',
		groups: 'context_var',
		func: 'strategy1',
		validation: {
			func: 'strategy1'
	...
	},
	{
		...
		description:
			"now() :: [Result: current date]<br/><br/>[Result: current date]: Date - date when the function was triggered. This function can be used as an attribute of transaction (for example as a default transaction date) or as a parameter of other function - for example for converting current date to string to write it to any string variable).<br/><br/>Examples:<br/>now() - to get a current date as a date object<br/>str(now()) - to get a current date as a string, in system format it returns string '2018-01-01' for current date 2018-01-01",
		groups: 'date',
		func: 'now()',
		validation: {
			func: 'now()'
	...
	},
	{
		...
		description:
			'random() :: [Result: number]<br/><br/>[Result: number]: Number - random number generated by the system (range of returned value =  0.0-1.0). It can be used in constructing any notes, user codes of entities.<br/><br/>Examples:<br/>random()<br/>random()*10<br/>random()+5<br/>coupon_size-random() - where coupon_size is any number variable used by user in his expressions',
		groups: 'number',
		func: 'random()',
		validation: {
			func: 'random()'
	...
	},
	{
		...
		description:
			'round([number],[decimals_number]) :: [Result: rounded_number]<br/><br/>[Result: rounded_number]: Number - rounded number (by math rule). For example, 23.5 gets rounded to 24, and −23.5 gets rounded to −24.<br/><br/>[number]: Number - any number or number variable, used by user in this expression (eg, 1.17, 1.56, 1.9987... or number_variable)<br/>[decimals_number]: Number - optional parameter - number of decimals, needed after rounding. User may not skip writing default value (0) in this function<br/><br/>Examples:<br/>round(23.5) for getting rounded result 24<br/>round(price) for getting rounded price of instrument written in variable with name [price]<br/>round(price,2) for getting rounded price with 2 decimals after rounding',
		groups: 'number',
	...
	},
	{
		...
		description:
			'abs([number]) :: [Result: absolute_number]<br/><br/>[Result: absolute_number]: Number - absolute number without sign. For example, -11.5 gets absolute number 11.5<br/><br/>[number]: Number - any number or number variable, used by user in this expression<br/><br/>Examples:<br/>abs(-10.599) for getting result 10.599<br/>abs(change_price) for getting absolute change of price written in variable with name [change_price]',
		groups: 'number',
		func: 'abs([number])',
		validation: {
			func: 'abs([number])'
...

	{
		name: 'Replace',
		description:
			'replace([string1],[oldValue],[newValue]) :: [Result: string1]<br/><br/>',
		groups: 'text',
	...
	},
	{
		...
		description:
			"get_instrument_accrued_price([instr], [trade_date]) :: [Result: accrued_price]<br/>[Result: accrued_price]: Number - accrued price (part of the total price of trade) for 1 quantity of the [instr] as of the [trade_date]<br/><br/>[instr]: Instrument - instrument for which the accrued price is calculated<br/>[trade_date]: Date - as of date for the accrued price calculation (usually trade date or settlement date) - date variable or date as a string object in format 'YY-mm-dd'<br/><br/>Examples:<br/>get_instrument_accrued_price(instrument, trade_date)<br/>get_instrument_accrued_price(instrument, '2019-01-01')<br/><br/>! if  user or system didn't set coupon size of the instrument (Settings for instrument), then [Result: accrued_price] equal to 0",
		groups: 'instr_formulas',
	...
	},
	{
		...
		description:
			'[instrument].price_multiplier: Number - multiplier applied for the Instrument price when valuing the Instrument. For example, for bonds which are priced as % of notional, the  price_multiplier should be  0.01<br/><br/>[instrument]: Instrument - variable contains instrument (instrument unique user code) defined by user in scheme, transaction type - user can address to the attributes of this object/entity (instrument) via these functions<br/><br/>Examples:<br/>instrument.price_multiplier<br/>instr.price_multiplier<br/><br/>! If this parameter was not specified in Instrument settings then result equal to 1',
		groups: 'instr',
	...
	},
	{
		name: 'Maturity price',
		description:
			'[instrument].maturity_price: Number - price of maturity (redemption) of the instrument, this parameter can be used in transaction types for instruments maturity<br/><br/>[instrument]: Instrument - variable contains instrument (instrument unique user code) defined by user in scheme, transaction type - user can address to the attributes of this object/entity (instrument) via these functions<br/><br/>Examples:<br/>instrument.maturity_price<br/>instr.maturity_price<br/><br/>! If this parameter was not specified in Instrument settings then result equal to 0',
		groups: 'instr',
		func: '.maturity_price',
		validation: {
	...
	},
	{
		name: 'Default price',
		description:
			'[instrument].default_price: Number - default price of instrument, it ca у used in cases when current prices for the instrument are unavailable<br/><br/>[instrument]: Instrument - variable contains instrument (instrument unique user code) defined by user in scheme, transaction type - user can address to the attributes of this object/entity (instrument) via these functions<br/><br/>Examples:<br/>instrument.default_price<br/>instr.default_price<br/><br/>! If this parameter was not specified in Instrument settings then result equal to 0',
		groups: 'instr',
		func: '.default_price',
		validation: {
	...
	},
	{
		name: 'Public name',
		description:
			'[account].public_name: Text - system public name for account shown when the user has no rights to see it`s real name<br/><br/>[account]: Account - variable contains account (account unique user code) defined by user in scheme, transaction type - user can address to the attributes of this object/entity (account) via these functions<br/><br/>Examples: <br/>account.public_name - if name of variable is [account]<br/>acc.public_name - if name of variable is [acc]',
		groups: 'account',
		func: '.public_name',
		validation: {
	...
	},
	{
		...
		description:
			'transactions[0].instrument.user_code: Text - system unique user code for instrument<br/>',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].instrument.name: Text - system name for instrument',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].instrument.short_name: Text - short name for instrument<br/> <br/>',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].instrument.maturity_date: Date - maturity date for instrument<br/>',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].portfolio.user_code: Text - system unique user code for portfolio',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].portfolio.short_name: Text - short name for portfolio',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].account_cash.user_code: Text - system unique user code for account cash',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].account_cash.name: Text - name for account cash',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].account_cash.short_name: Text - short name for account cash<br/>',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].account_cash.public_name: Text - public name for account cash',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].account_cash.user_code: Text - system unique user code for account position',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].account_cash.name: Text - name for account position',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].account_cash.short_name: Text - short name for account position<br/>',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].account_cash.public_name: Text - public name for account position',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].account_cash.user_code: Text - system unique user code for account interim',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].account_cash.name: Text - name for account interim',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].account_cash.short_name: Text - short name for account interim<br/>',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].account_cash.public_name: Text - public name for account interim',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].counterparty.user_code: Text - system unique user code for counterparty',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].counterparty.name: Text - name for counterparty',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].counterparty.short_name: Text - short name for counterparty',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].responsible.user_code: Text - system unique user code for responsible',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].responsible.name: Text - name for responsible',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].responsible.short_name: Text - short name for responsible',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].accounting_date: Date - accounting (trade) date for transaction',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].cash_date: Date - cash (settlement) date for transaction',
		groups: 'transact_des',
	...
	},
	{
		name: 'Position',
		description:
			'transactions[0].position_size_with_sign: Number - position size with sign (change of position as the result of transaction)',
		groups: 'transact_des',
	...
	},
	{
		name: 'Principal',
		description:
			'transactions[0].principal_with_sign: Number - principal size with sign (change of principal as the result of transaction)<br/>',
		groups: 'transact_des',
	...
	},
	{
		name: 'Carry (accrued)',
		description:
			'transactions[0].carry_with_sign: Number - carry (accrued) with sign (change of carry (accrued) as the result of transaction)<br/>',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].overheads_with_sign: Number - overheads with sign (commission)',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].cash_consideration: Number - cash consideration with sign (change of cash as the result of transaction)',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].transaction_currency.name: Text - name for transaction currency',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].transaction_currency.user_code: Text - system unique user code for transaction currency',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].settlement_currency.name: Text - name for settlement currency',
		groups: 'transact_des',
	...
	},
	{
		...
		description:
			'transactions[0].settlement_currency.user_code: Text - system unique user code for settlement currency',
		groups: 'transact_des',
	...
	},
	{
		name: 'Date',
		description:
			"any date in format 'YY-mm-dd' , whereas dd - day, mm - month, yy - year with century",
		groups: 'data_types',
		func: ' ',
		validation: {
			func: ' '
	...
	},
	{
		name: 'Number',
		description:
			'any number in format  ### (integer) and ###.### (float number with decimals). Don`t use other format, eg ###,### or ###-### or ### ###',
		groups: 'data_types',
		func: ' ',
		validation: {
			func: ' '
	...
	},
	{
		name: 'Text',
		description:
			"any sequence of symbols, max 256 symbols. String should start and end with apostrophe (') or ditto-mark (')",
		groups: 'data_types',
		func: ' ',
		validation: {
			func: ' '
	...
	},
	{
		name: 'Arrays',
		description:
			'List of the objacts having same Data Type. The elements of the n-th element of the list is referred as: List[n]<br/>The numeration alwas starts from [0]<br/><br/>For Example:<br/>transaction[0], transaction[1]',
		groups: 'data_types',
		func: ' ',
		validation: {
			func: ' '
	...
	},
	{
		...
		description:
			"boolean parameter - 'true' of 'false' in computer format (not as a string!). It can be used by the system or user in his expressions as a parameter of complicated functions",
		groups: 'data_types',
		func: ' ',
		validation: {
			func: ' '
	...
	},
	{
		name: 'Effective Date',
		description:
			'[effective_date] :: [Result: [effective_date]]<br/><br/>[Result: [effective_date]]:  Effective_date - variable autofilled from context, in this case context is an event generated by the system for instrument with predefined events in settings. Events are generated on a specific date according to a schedule of events (for example, a coupon payment schedule) created in the settings of each instrument. And this date is transmitted from context variable to user`s variable [effective_date] used in transaction type for event transaction<br/><br/>[effective_date]: Date  - any date variable, used by user in this expression<br/><br/>Examples:<br/>[effective_date]<br/>[e_date]<br/>[coupon_date]',
		groups: 'context_var',
		func: 'effective_date',
		validation: {
			func: 'effective_date'
	...
	},
	{
		name: 'Convert String to Number',
		description:
			"float([string]) :: [Result: number_from_string]<br/><br/>[Result: number_from_string]: Number - number converted from string. For example, '10' gets converted to 10 as a number data, and '13.999' gets converted to 13.999. This function is used to convert any string variables (for example notes, where user can wrote numbers, but for the system it is still string data)<br/><br/>[string] - any string or string variable, used by user in this expression<br/><br/>Examples:<br/>int('25') for getting data as a number object 25<br/>float('25.09') for getting data as a number object 25.09<br/>int(notes) for getting data as a number object from string variable with name [notes]<br/>float(notes) for getting data as a number object from string variable with name [notes]",
		groups: 'number',
		func: 'float([string])',
		validation: {
			func: 'float([string])'
	...
	},
	{
		...
		description:
			"format_date([date], [format]='%Y-%m-%d') :: [Result: formatted date]<br/><br/>[Result: formatted date]: String - [date] is converted into String as per the specified format [format]<br/><br/>[date]:Date - date to convert<br/>[format]:String - date specification of the date format (see Date/Formats)",
		groups: 'date',
	...
	},
	{
		...
		description:
			"Numeric operators: +, -, / (division), *, % (mod)<br/>Text concatenation: +<br/>Date operators: <Date> + days(<n days>)<br/>Variable Parameters:  instrument.price_multiplier , instrument['price_multiplier'], context['instrument']['price_multiplier']<br/>Comparison: ==, !=, >, >=, <, <=<br/>If operator:  iif(<expression>,<value if true>,<value if false>)",
		groups: '',
		func: ' ',
		validation: {
			func: ' '
	...
	},
	{
		...
		description:
			'The Expressions Language syntax resembles syntax of Python. For ease of compiling Expressions one can use Notepad++ freeware which applies colour scheme to the text and helps in writing complex Expressions.<br/><br/>Function description:   function_name(arg1, arg2=<default value for arg>)<br/>Data types: see Data Types tab',
		groups: '',
		func: ' ',
		validation: {
			func: ' '
	...
	},
	{
		...
		description:
			"simple_price(date, date1, value1, date2, value2)<br/>   calculate price on date using 2 point (date1, value1) and (date2, value2)<br/><br/><br/>if dates is string then that try parse use '%Y-%m-%d'",
		groups: 'pricing',
	...
	},
	{
		...
		description:
			'dynamic attributes (in future releases):<br/>       value_string: str - used for string type<br/>       value_float: float - used for number type<br/>       value_date: date - used for date type<br/>       classifier: null - used for classifier type<br/>           name: str<br/>           level: int<br/>           parent: recursive classifier data',
		groups: 'user_attr',
	...
	},
	{
		name: 'With Text',
		description:
			'The most common issues:<br/>1. make sure that in text expression all summands are text variables or cinverte to text (if date/number)',
		groups: 'issues',
		func: ' ',
		validation: {
			func: ' '
	...
	},
	{
		name: 'Strategy 2',
		description:
			'[strategy2] :: [Result: Strategy]<br/><br/>[Result: Strategy]:  Strategy - variable autofilled from the Context (see Context Variables / Context).  The variable stores the Strategy 2 of the selected Context.',
		groups: 'context_var',
		func: 'strategy2',
		validation: {
			func: 'strategy2'
	...
	},
	{
		name: 'Strategy 3',
		description:
			'[strategy3] :: [Result: Strategy]<br/><br/>[Result: Strategy]:  Strategy - variable autofilled from the Context (see Context Variables / Context).  The variable stores the Strategy 3 of the selected Context.',
		groups: 'context_var',
		func: 'strategy3',
		validation: {
			func: 'strategy3'
	...
	},
	{
		...
		description:
			"set_complex_transaction_input([input], [value])) :: [Result: None]<br/><br/>[input]: String - input name<br/>[Result: default input]: String, number, date or entity - as a default input of transaction type<br/><br/>Examples:<br/>get_ttype_default_input('price')<br/>get_ttype_default_input('currency')<br/>get_ttype_default_input('currency').user_code - attribute [user_code] of default currency<br/>get_ttype_default_input('maturity_date')<br/>get_ttype_default_input('notes')",
		groups: 'transaction',
	...
	},
	{
		...
		description:
			"set_complex_transaction_form_data([key], [value])) :: [Result: None]<br/><br/>[key]: String - input name<br/>[Result: default input]: String, number, date or entity - as a default input of transaction type<br/><br/>Examples:<br/>get_ttype_default_input('price')<br/>get_ttype_default_input('currency')<br/>get_ttype_default_input('currency').user_code - attribute [user_code] of default currency<br/>get_ttype_default_input('maturity_date')<br/>get_ttype_default_input('notes')",
		groups: 'transaction',
	...
	},
	{
		...
		description:
			"get_relation_by_user_code([content_type], [user_code])) :: [Result: relation object]<br/><br/>[content_type]: String - input name<br/>[user_code]: String - relation user code<br/>[[Result: relation object]: String, number, date or entity<br/><br/>Examples:<br/>get_relation_by_user_code('currencies.currency', 'USD')<br/>get_relation_by_user_code('instruments.instrumenttype', 'bonds')<br/>get_relation_by_user_code('currencies.currency', 'USD').user_code - attribute [user_code]",
		groups: 'transaction',
	...
	},
	{
		...
		description:
			"get_currency_field([currencyID], [parameter_name]): [Result: value of currency field]<br/>[Result: value of currency field]: Number, date or text in parameter (attribute) of currency (for example short name, default rate etc)<br/>[currencyID] - currency (user code of currency) contained in variable or text (for example tr_currency or 'AUD')<br/>[parameter_name] - parameter of currency contained in variable or text (for example param_var or 'default_fx_rate')<br/><br/>Examples:<br/><br/>get_currency_field('AUD', 'default_fx_rate') - to get default fx rate of currency with user code AUD<br/>get_currency_field(tr_currency, def_param) - to get parameter (in variable [def_param]) of currency (in variable [tr_currency])",
		groups: 'currency',
...
export const CONTEXT_VARIABLES_WORDS = [
	'context_instrument',
	'context_portfolio',
	'context_account',
	'context_strategy1',
	'context_strategy2',
	'context_strategy3',
	'context_position_size',
	'context_currency',
	'context_effective_date',
	'context_notification_date',
	'context_final_date',
	'context_maturity_date',
	'context_report_date',
	'context_report_start_date',
	'context_accrued_currency',
	'context_pricing_currency',
	'context_pricing_policy',
	'context_allocation_balance',
	'context_allocation_pl',

	'phantom_instrument_0',
	'phantom_instrument_1',
	'phantom_instrument_2',
	'phantom_instrument_3',
	'phantom_instrument_4',
	'phantom_instrument_5',
	'phantom_instrument_6',
	'phantom_instrument_7',
	'phantom_instrument_8',
	'phantom_instrument_9',
	'phantom_instrument_10'
];

export const EXPRESSION_VALIDATION_DESCRIPTIONS = {
	success: { text: 'Expression is valid', color: '#76cb58' },
	error: { text: 'Invalid expression', color: '#e50005' },
	'inputs-error': {
		text: 'Not all variables are identified expression',
		color: '#de6546'
	},
	'bracket-error': {
		text: 'Mismatch in the opening and closing braces',
		color: '#e50005'
	}
};
