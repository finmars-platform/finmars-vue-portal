...
<!--				<FmInputEntityNames label="Relation name"
														v-model:fullName="eFullName"
														@update:fullName="testNameChange()"
														v-model:shortName="eShortName"
														@update:shortName="testNameChange()"
														v-model:userCode="eUserCode"
														@update:userCode="testNameChange()"
														v-model:publicName="ePublicName"
														@update:publicName="testNameChange()" />-->
...
//<editor-fold desc="FmInputEntityNamesExample">
let eFullName = ref('');
let eShortName = ref('');
let eUserCode = ref('');
let ePublicName = ref('');

function testNameChange(nameVal) {
	console.log("testing testNameChange ", nameVal);
}
