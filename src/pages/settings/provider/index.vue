<template>
	<div class="px-5 py-5 flex flex-col items-start justify-start gap-6">
		<div class="flex flex-col w-full gap-2">
			<span class="text-lg">Provider</span>
			<div
				v-if="loading"
...
<script setup>
	import ProviderModal from '@/pages/settings/provider/provider-modal/index.vue';
	...
	const modalTitle = ref('Create Provider');
	const items = ref([]);
	...
	async function openModal(item = null) {
		...
		modalTitle.value = !item ? 'Create Provider' : 'Edit Provider';
