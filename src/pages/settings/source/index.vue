...
<script setup>
	import SourceModal from '@/pages/settings/source/source-modal/index.vue';
	...
	const modalTitle = ref('Create Source');
	const items = ref([]);
	...
	async function openModal(item = null) {
		...
		modalTitle.value = !item ? 'Create Source' : 'Edit Source';
