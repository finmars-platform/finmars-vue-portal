import * as currencyMappingService from '~/services/currency/currencyMappingService';
import * as instrumentTypeMappingService from '~/services/instrument/instrumentTypeMappingService';
import * as accrualCalculationModelService from '~/services/accrual-calculation/accrualCalculationModelService';
import * as instrumentPeriodicityMappingService from '~/services/instrument/instrumentPeriodicityMappingService';
import * as instrumentAttributeTypeMappingService from '~/services/instrument/instrumentAttributeTypeMappingService';
import * as accountMappingService from '~/services/account/accountMappingService';
import * as accountTypeMappingService from '~/services/account/accountTypeMappingService';
import * as instrumentMappingService from '~/services/instrument/instrumentMappingService';
import * as counterpartyMappingService from '~/services/counterparty/counterpartyMappingService';
import * as responsibleMappingService from '~/services/responsible/responsibleMappingService';
import * as portfolioMappingService from '~/services/portfolio/portfolioMappingService';
import * as strategy1MappingService from '~/services/strategy/strategy1MappingService';
import * as strategy2MappingService from '~/services/strategy/strategy2MappingService';
import * as strategy3MappingService from '~/services/strategy/strategy3MappingService';
import * as dailyPricingModelMappingService from '~/services/dailyPricingModelMappingService';
import * as pricingConditionMappingService from '~/services/pricing/pricingConditionMappingService';
import * as paymentSizeDetailMappingService from '~/services/paymentSizeDetailMappingService';
import * as priceDownloadSchemeMappingService from '~/services/price/priceDownloadSchemeMappingService';
import * as pricingPolicyMappingService from '~/services/pricing/pricingPolicyMappingService';
